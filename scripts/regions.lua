...
function south_swamp()
    return bottleCount(1) or (has_hard_projectiles() and has("deku")) or (has("pictobox") and has("deku") and has("soul_swamp_guide")) or (can_use_owl("owl_woodfall") and has("deku"))
end
...
function woodfall()
    return south_swamp() and ((has("deku") and has_absurd_soul("soul_deku_flowers")) or can_use_owl("owl_woodfall"))
end
...
function clear_greatbay()
    return great_bay_temple() and has("hookshot") and has_boss_soul("soul_gyorg") and ((can_use_ice_arrows() and can_use_fire_arrows() and has("bosskey_gb")) or (has("gyorg") and has("boss_warps_with_remains")))
end
