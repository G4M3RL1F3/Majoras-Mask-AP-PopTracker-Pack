...
function onClear(slot_data)
    ...
    setFromSlotData("shuffle_maps_and_compasses","shuffle_maps_and_compasses")
    ...
    setFromSlotData("shuffle_stray_fairies","shuffle_stray_fairies")
    ...
    setFromSlotData("infinite_magic_behavior","infinite_magic_behavior")
    setFromSlotData("skip_digging","skip_digging")
